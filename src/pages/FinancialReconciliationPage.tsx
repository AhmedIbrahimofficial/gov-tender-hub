    ...
    <div className="fixed inset-0 bg-black/40 z-40 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col">
        ...
        <div className="border-t border-black/8 px-6 py-3 flex justify-between bg-[#fafafa]">
          ...
          <button onClick={() => pushNotification("Financial summary report downloaded.", "success")} className="h-8 px-4 rounded-lg border border-black/10 text-xs hover:bg-[#F5F5F5] flex items-center gap-1.5 ml-auto">
