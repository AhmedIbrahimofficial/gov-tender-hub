...
export const navSections = [
  ...
  },
  {
    ...
    icon: "ShoppingCart",
    items: [
      { to: "/workbench",                     label: "E-Procurement Home",       icon: "LayoutDashboard" },
      { to: "/workbench/tender-management",   label: "Tenders",                  icon: "Newspaper"       },
      { to: "/workbench/rfq",                 label: "RFQ",                      icon: "ShoppingCart"    },
      { to: "/workbench/rfp",                 label: "RFP",                      icon: "FileText"        },
      { to: "/workbench/eoi",                 label: "EOI",                      icon: "ClipboardList"   },
      { to: "/workbench/auction",             label: "Auctions",                 icon: "Gavel"           },
      { to: "/workbench/bid-submission",      label: "Unsolicited Bids",         icon: "Send"            },
    ],
  },
  {
    ...
    icon: "Building2",
    items: [
      { to: "/vendors",                        label: "Registration",             icon: "Building2"       },
      { to: "/vendor-workbench/dashboard",     label: "KYC",                      icon: "ShieldCheck"     },
      { to: "/vendor-workbench/tasks",         label: "Profiling",                icon: "ClipboardList"   },
      { to: "/performance",                    label: "Vetting",                  icon: "CheckCircle"     },
    ],
  },
  {
    ...
    items: [
      ...
      { to: "/bi-dashboards",      label: "BI Dashboards",       icon: "BarChart3" },
      { to: "/analytics",          label: "Analytics",           icon: "BarChart3" },
      { to: "/workbench/ai-analytics", label: "AI Analytics",   icon: "Sparkles"  },
      { to: "/workbench/reports",  label: "Reports",             icon: "BarChart3" },
      { to: "/anti-corruption",    label: "Anti-Corruption",     icon: "AlertOctagon" },
      { to: "/audit",              label: "Audit Intelligence",  icon: "ShieldCheck" },
    ],
  },
  {
