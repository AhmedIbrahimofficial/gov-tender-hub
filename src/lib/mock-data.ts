...
export const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/procurement/planning",     label: "Procurement Planning",   icon: "ClipboardList" },
      { to: "/procurement/requisition",  label: "Requisition Workbench",  icon: "ShoppingCart"  },
      { to: "/procurement/strategy",     label: "Procurement Strategy",   icon: "Target"        },
      ...
      { to: "/evaluations",       label: "Evaluations",            icon: "Scale"        },
