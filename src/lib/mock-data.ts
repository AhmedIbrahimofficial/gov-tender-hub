...
export const navSections = [
  {
    label: "My Work Space",
    items: [
      { to: "/dashboard",             label: "Procurement Dashboard",   icon: "LayoutDashboard" },
      ...
      { to: "/analytics",             label: "Procurement Analytics",   icon: "BarChart3" },
      { to: "/bi-dashboards",         label: "Procurement Dashboard",   icon: "BarChart3" },
  ...
  },
  {
    ...
    items: [
      { to: "/governance",    label: "Procurement Governance",  icon: "ShieldCheck"   },
